...
const Navbar = (props: Props) => {
    return (
        <div className="navbar fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-30 backdrop-blur-md shadow-lg border border-gray-200 rounded-lg mx-64 my-2 p-2">
